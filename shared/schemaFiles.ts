...
// ./schema directory cube_api itself loads from (see the README's
// "Getting started" section). This is the one thing in this app that can
// never drift from what's actually deployed -- it's the literal file on
// disk, not a copy, a git ref, or a cached snapshot.
